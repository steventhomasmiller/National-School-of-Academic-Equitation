	...
	<div class="col-md-4 col-sm-4 backg wht-lttr"><?php dynamic_sidebar('craig-left-sidebar'); ?></div>
		...
		<div class="col-sm-8"> <?php echo do_shortcode('[wonderplugin_slider id="1"]'); ?>
					...
					<div class="row-fluid"><!-- ************ nested column ************** -->
						...
						<div class="col-sm-6 pad-fix heading-fix article-bkg"><?php dynamic_sidebar( 'craig-center-sidebar' ); ?></div><!-- column center -->
																													
						<div class="col-sm-6 pad-fix heading-fix article-bkg"><?php dynamic_sidebar( 'craig-right-sidebar' ); ?></div><!-- column right -->
