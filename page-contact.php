...
<div class="row-fluid"><!-- map and form -->
    <div class="col-md-7 map">
        <?php echo '<iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d2679.913438437759!2d-122.07241210000001!3d47.8025137!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x5490099fa8cb1b87%3A0x58fdfaa57191842b!2s11901+215th+Pl+SE%2C+Snohomish%2C+WA+98296!5e0!3m2!1sen!2sus!4v1415999981823" width="100%" height="400" frameborder="0" style="border:0"></iframe>';?>
    </div>

    <div class="col-md-5 contact">
        <?php get_post(); ?><?php echo do_shortcode("[contact-form-7 id='406']"); ?> <!--Change id to 406 when pushing to live site -->
    </div>
</div>
